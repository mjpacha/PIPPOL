 ...
 */
@WebServlet(name = "ControlaPublicacion", urlPatterns = {"/ControlaPublicacion"})
public class ControlaPublicacion extends HttpServlet {
    String listar = "Vista/Publicaciones.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            //listado con todos los datos del usuario
            ...
            //redireccion a la página JPS de publicaciones
